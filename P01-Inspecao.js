/* Projeto 01
                                                        INSPEÇÃO DO SITE DO YOUTUBE

Elemento da logo que fica no canto superior esquerdo do YouTube:
...
Seu caminho no JavaScript: document.querySelector("#logo-icon")

Funciona de forma que quando o usuário clica nesse botão a aba é redirecionada para a home do YouTube.
------------------------------------------------------------------------------------------------------------------------------------------------

Elemento do botão de menu que fica no canto superior esquerdo do YouTube:
...
Seu caminho no JavaScript: document.querySelector("#guide-icon")

Clicando nele é aberto um menu que é responsável pela guia de navegação de páginas padrões do YouTube(Inscrições, Histórico, Explorar).
-----------------------------------------------------------------------------------------------------------------------------------------------

Elemento responsável pelo botão de notificações(o famoso sininho):
...
Seu caminho no JavaScript: document.querySelector("#button > yt-icon-badge-shape > div > div > yt-icon")

Abrirá uma caixa com as noticações dos canais em que se é inscrito.
------------------------------------------------------------------------------------------------------------------------------------------------



                                                        INSPEÇÃO DO SITE DA AMAZON

Elemento responsável pelo botão de "Mais Vendidos":
<a href="/gp/bestsellers/?ref_=nav_cs_bestsellers" class="nav-a  " tabindex="0" data-csa-c-type="link" data-csa-c-slot-id="nav_cs_2" data-csa-c-content-id="nav_cs_bestsellers" data-csa-c-id="vfozpx-acyrxn-rddnt3-xwj7uj">Mais Vendidos</a>

Seu caminho no JavaScript: document.querySelector("#nav-xshop > a:nth-child(4)")

Tem função de redirecionar para a página de produtos mais vendidos.
-------------------------------------------------------------------------------------------------------------------------

Elemento relacionado ao login:
<span id="nav-link-accountList-nav-line-1" class="nav-line-1 nav-progressive-content">Olá, Faça seu login</span>

Seu caminho no JavaScript: document.querySelector("#nav-link-accountList-nav-line-1")

Leva o usuário à página de login da Amazon.
-------------------------------------------------------------------------------------------------------------------------

Elemento do carrinho de compras:
<span class="nav-cart-icon nav-sprite"></span>

Seu caminho no JavaScript: document.querySelector("#nav-cart-count-container > span.nav-cart-icon.nav-sprite")

Por meio dele podemos acessar o carrinho de compras do site.
*/